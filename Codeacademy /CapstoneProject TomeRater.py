...
class User(object):
    ...
    def change_email(self, address):
        self.email = address
        print("The users {} email has been updated to {}".format(self.name, self.email))
...
class Book(object):
    ...
    def set_isbn(self, new_ISBN):
        self.isbn = new_ISBN
        print("The ISBN of the book {} has been updated to another ISBN {}".format(self.title, self.isbn))
